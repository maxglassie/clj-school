...
The `home-routes` handler in the `clj-school.routes.home` namespace
...
The `home-page` function will in turn call the `clj-school.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/clj_school/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `clj-school.handler` namespace:
...
Request middleware functions are located under the `clj-school.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `clj-school.dev-middleware` namespace found in
